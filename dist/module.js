define(["app/plugins/sdk","d3","lodash"], function(__WEBPACK_EXTERNAL_MODULE_grafana_app_plugins_sdk__, __WEBPACK_EXTERNAL_MODULE_grafana_d3__, __WEBPACK_EXTERNAL_MODULE_grafana_lodash__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/***/ "../node_modules/css-loader/dist/cjs.js!./css/d3-flamegraph.css":
/*!**********************************************************************!*\
  !*** ../node_modules/css-loader/dist/cjs.js!./css/d3-flamegraph.css ***!
  \**********************************************************************/
...
/***/ "../node_modules/css-loader/dist/cjs.js!./css/flame-graph-panel.css":
/*!**************************************************************************!*\
  !*** ../node_modules/css-loader/dist/cjs.js!./css/flame-graph-panel.css ***!
  \**************************************************************************/
/*! no static exports found */
...
exports = module.exports = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/api.js */ "../node_modules/css-loader/dist/runtime/api.js")(false);
// Module
exports.push([module.i, ".flame-graph-panel {\n  display: flex;\n  align-items: center;\n/*  justify-content: center; */\n  flex-direction: column-reverse;\n  overflow: auto;\n}\n\n.flame-graph-panel #chart {\n  display: flex;\n  width: 100%;\n  height: 100%;\n  margin: 0px;\n  padding: 0px;\n  overflow: auto;\n}\n\n.d3-flame-graph {\n  display: flex;\n  margin: 0px;\n  padding: 0px;\n  overflow: auto;\n}\n\n.d3-flame-graph .label {\n  background-color: transparent;\n}", ""]);
...
(function (global, factory) {
  ...
  var selection_clone = function selection_clone(deep) {
  ...
  var formatTrim = function formatTrim(s) {
  ...
  var interpolateValue = function interpolateValue(a, b) {
    ...
    return b == null || t === "boolean" ? constant$3(b) : (t === "number" ? interpolateNumber : t === "string" ? (c = color(b)) ? (b = c, interpolateRgb) : interpolateString : b instanceof color ? interpolateRgb : b instanceof Date ? date : Array.isArray(b) ? array$2 : typeof b.valueOf !== "function" && typeof b.toString !== "function" || isNaN(b) ? object : interpolateNumber)(a, b);
  };
  ...
  var flamegraph = function flamegraph() {
    ...
    var getLibtype = function getLibtype(d) {
      return d.data.l || d.data.libtype;
    };

    var getDelta = function getDelta(d) {
      if ('d' in d.data) {
        return d.data.d;
      } else {
        return d.data.delta;
    ...
    var searchMatch = function searchMatch(d, term) {
      var re = new RegExp(term);
      var label = getName(d);
      return typeof label !== 'undefined' && label && label.match(re);
    };

    var originalSearchMatch = searchMatch;

    var detailsHandler = function detailsHandler(d) {
      if (detailsElement) {
        if (d) {
    ...
    var labelHandler = function labelHandler(d) {
      return getName(d) + ' (' + format('.3f')(100 * (d.x1 - d.x0), 3) + '%, ' + getValue(d) + ' samples)';
    };

    var tip = d3Tip().direction('s').offset([8, 0]).attr('class', 'd3-flame-graph-tip').html(function (d) {
    ...
    var colorMapper = function colorMapper(d) {
    ...
    function update() {
      selection.each(function (root) {
        ...
        var g = select(this).select('svg').selectAll('g').data(descendants, function (d) {
          return d.id;
        ...
        g = select(this).select('svg').selectAll('g').data(descendants, function (d) {
          return d.id;
        });
    ...
    function forEachNode(node, f) {
      ...
      if (children) {
        ...
        var _count, child, grandChildren;
    ...
    function reappraiseNode(root) {
      var node, children, grandChildren, childrenValue, i, j, child, childValue;
      var stack = [];
      var included = [];
      var excluded = [];
      var compoundValue = !selfValue;
      var item = root.data;
    ...
    function chart(s) {
      ...
      selection.each(function (data) {
        if (!svg) {
          svg = select(this).append('svg:svg').attr('width', w).attr('height', h || (root.height + 2) * c).attr('class', 'partition d3-flame-graph').call(tip);
    ...
    chart.setColorMapper = function (_) {
      ...
      colorMapper = function colorMapper(d) {
        var originalColor = originalColorMapper(d);
...
var content = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js!./d3-flamegraph.css */ "../node_modules/css-loader/dist/cjs.js!./css/d3-flamegraph.css");
...
var content = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js!./flame-graph-panel.css */ "../node_modules/css-loader/dist/cjs.js!./css/flame-graph-panel.css");
...
exports.FlameGraphCtrl = void 0;

var _sdk = __webpack_require__(/*! grafana/app/plugins/sdk */ "grafana/app/plugins/sdk");

var _lodash = _interopRequireDefault(__webpack_require__(/*! grafana/lodash */ "grafana/lodash"));

var d3 = _interopRequireWildcard(__webpack_require__(/*! grafana/d3 */ "grafana/d3"));

var _d3FlameGraph = __webpack_require__(/*! d3-flame-graph */ "../node_modules/d3-flame-graph/dist/d3-flamegraph.js");

__webpack_require__(/*! ./css/d3-flamegraph.css */ "./css/d3-flamegraph.css");

__webpack_require__(/*! ./css/flame-graph-panel.css */ "./css/flame-graph-panel.css");
...
function (_MetricsPanelCtrl) {
  ...
  function FlameGraphCtrl($scope, $injector) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(FlameGraphCtrl).call(this, $scope, $injector));

    _defineProperty(_assertThisInitialized(_this), "onInitEditMode", function () {
      // determine the path to this plugin
      var panels = grafanaBootData.settings.panels;
      var thisPanel = panels[_this.pluginId];
      var thisPanelPath = thisPanel.baseUrl + '/'; // add the relative path to the editor

      var editorPath = thisPanelPath + 'partials/editor.html';

      _this.addEditorTab('Options', editorPath, 2);
    });

    _defineProperty(_assertThisInitialized(_this), "onDataError", function (err) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onDataReceived", function (dataList) {
      var data = dataList.map(_this.tableHandler.bind(_assertThisInitialized(_this)));
    ...
    _defineProperty(_assertThisInitialized(_this), "getColumnId", function (data, columnName) {
    ...
    _defineProperty(_assertThisInitialized(_this), "setValueRec", function (tree, signature, value) {
      tree.value = tree.value + value; // `signature` is the current node
      ...
      signature.shift(); // already existing children

      for (var i = 0; i < tree.children.length; i++) {
        if (tree.children[i].name === currentPart) {
          tree.children[i] = _this.setValueRec(tree.children[i], signature, value);
          return tree;
        }
      } // new children


      tree.children.push(_this.setValueRec({
        name: currentPart,
        value: 0,
        children: []
      }, signature, value));
    ...
    _defineProperty(_assertThisInitialized(_this), "setValues", function (data) {
      return Object.keys(data).reduce(function (acc, current) {
        ...
        acc = _this.setValueRec(acc, current.split(_this.panel.mapping.signatureSeparator), data[current]);
        return acc;
    ...
    _defineProperty(_assertThisInitialized(_this), "tableHandler", function (tableData) {
      ...
      return tableData.rows.reduce(function (acc, current) {
        ...
        if (acc[signature] == null) acc[signature] = parseInt(current[columnIdValue], 10);else acc[signature] += parseInt(current[columnIdValue], 10);
        return acc;
      }, {});
    });

    _defineProperty(_assertThisInitialized(_this), "colorFunction_random", function () {});

    _defineProperty(_assertThisInitialized(_this), "colorFunction_single", function () {});

    _defineProperty(_assertThisInitialized(_this), "colorFunction_module", function () {});

    _defineProperty(_assertThisInitialized(_this), "colorFunction_scale", function () {});

    _defineProperty(_assertThisInitialized(_this), "setFrameColor", function () {
      var colorFunctions = {
      ...
      if (colorFunctions[_this.colorFunction]) {
        colorFunctions[_this.colorFunction]();
      }
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "link", function (scope, elem, attrs, ctrl) {
      ...
      function getFlamegraphSize() {
        try {
          ...
          if (_lodash["default"].isString(height)) {
    ...
    _this.events.on('render', _this.onRender.bind(_assertThisInitialized(_this))); // custom event from link -> render()
...
exports.FlameGraphCtrl = FlameGraphCtrl;

_defineProperty(FlameGraphCtrl, "templateUrl", 'partials/module.html');
...
Object.defineProperty(exports, "PanelCtrl", {
  enumerable: true,
  get: function get() {
    return _flame_graph_ctrl.FlameGraphCtrl;
  }
});

var _flame_graph_ctrl = __webpack_require__(/*! ./flame_graph_ctrl.js */ "./flame_graph_ctrl.js");
...
module.exports = __WEBPACK_EXTERNAL_MODULE_grafana_d3__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE_grafana_lodash__;
